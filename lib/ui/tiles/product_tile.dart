    ...
    return InkWell(
      onTap: () {
        ...
        Message.alertDialogConfirm(context,
            ...
            title: _product.productName, widget:
          ...
          _product.productQuantity =
              ProductModel.of(context).singleProductQuantity;

          await ProductModel.of(context).updateProduct(_product, onSuccess: () {
            print("sucesso");
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                          image: _product.productImageUrl == null ||
                                  _product.productImageUrl.isEmpty
