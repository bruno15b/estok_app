class Stock {
  ...
  static const String TOTAL_PRODUCT_QUANTITY_FIELD = "quantidade_total";
  static const String ENTER_DATE_FIELD = "data_entrada";
  static const String VALIDITY_DATE_FIELD = "data_validade";
  static const String TYPE_OF_PRODUCT_FIELD = "tipo";
  ...
  factory Stock.fromJson(Map<String, dynamic> json) {
    return Stock(
      ...
      totalProductQuantity: (json[TOTAL_PRODUCT_QUANTITY_FIELD] as num).toDouble(),
      enterDate: DateTime.parse(json[ENTER_DATE_FIELD]),
      validityDate: DateTime.parse(json[VALIDITY_DATE_FIELD]),
      typeOfProduct: (json[TYPE_OF_PRODUCT_FIELD] as String),
